        ...
        <div className="flex flex-grow items-center justify-center p-6">
          <div className='flex flex-col w-full gap-4'>
            <div className='flex flex-row justify-center w-full h-full gap-4'>
              ...
              <ProfileCard name={'Thitinan P.'} position={'Front-end'} imageURL={'public/Image/tek.jpg'} contacts={{
              ...
              <ProfileCard name={'Isoon S.'} position={'IT Support'} imageURL={'public/Image/ozone.jpg'} contacts={{
              ...
              <ProfileCard name={'Chotipat S.'} position={'Back-end'} imageURL={'public/Image/kul.jpg'} contacts={{
            ...
            <div className='flex flex-row justify-center w-full h-full gap-4'>
              <ProfileCard name={'Suphakorn L.'} position={'Back-end'} imageURL={'public/Image/J.jpg'} contacts={{
              ...
              <ProfileCard name={'Jetsadakorn P.'} position={'Full-stack'} imageURL={'public/Image/arm.jpg'} contacts={{
